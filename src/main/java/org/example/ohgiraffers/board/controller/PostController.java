 ...
 *      각 계층이 독립적으로 구성되서, 한계층이 변경이 일어나도, 다른 계층에 영향을 주지 않는다.
 ...
 *      하지만 종종 Controller를 쓰면서도 데이터를 반환해야 할 때가 있는데, 이럴 때 사용하는 것이 @ResponseBody 이다.
 *
 *      REST란?
 *          Representational Estate Transfer의 약자
 *          자원을 이름으로 구분하여 자원의 상태를 주고 받는 것을 의미
 *          REST 는 기본적으로 웹의 기존 기술과 HTTP 프로토콜을 그대로 사용하기 때문에,
 *          웹을 장점을 최대한 활용할 수 있는 아키텍쳐 스타일이다.
 */

@Tag(name = "posts", description = "게시글 API")
@Controller
@ResponseBody
//@RequestMapping : 특정 URL 을 매핑하게 도와준다
